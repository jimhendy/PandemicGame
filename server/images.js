function createImage(image_file, context, x_frac, y_frac, dx_frac, dy_frac, tooltip=null){
    var img = new Image();
...
function alter_image(img, context, new_image_file){
    clearImage(img);
...
function clearImage(img, context){
    context.clearRect(
...
function move(object, context, destination_x, destination_y, duration, updateInterval=25){

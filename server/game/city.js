class City {
    constructor(io, game_id, queue, diseases, markers, name, native_disease_colour, location, adjacent_city_names) {
        this.io = io;
...
module.exports = {
    create_cities: function (io, game_id, queue, diseases, markers) {
        city_list = [
            ...
            new City(io, game_id, queue, diseases, markers, "Kinshasa", "yellow", [0.501, 0.603], ["Lagos", "Khartoum", "Johannesburg"]),
            new City(io, game_id, queue, diseases, markers, "Khartoum", "yellow", [0.545, 0.516], ["Cairo", "Johannesburg", "Lagos", "Kinshasa"]),
            new City(io, game_id, queue, diseases, markers, "Johannesburg", "yellow", [0.538, 0.70], ["Kinshasa", "Khartoum"]),
            new City(io, game_id, queue, diseases, markers, "Lagos", "yellow", [0.457, 0.535], ["Kinshasa", "Khartoum", "Sao Paulo"]),
            new City(io, game_id, queue, diseases, markers, "Lima", "yellow", [0.20, 0.657], ["Mexico City", "Bogota", "Santiago"]),
            new City(io, game_id, queue, diseases, markers, "Los Angeles", "yellow", [0.088, 0.436], ["Sydney", "Mexico City", "San Francisco", "Chicago"]),
            new City(io, game_id, queue, diseases, markers, "Mexico City", "yellow", [0.152, 0.467], ["Los Angeles", "Chicago", "Miami", "Bogota", "Lima"]),
            new City(io, game_id, queue, diseases, markers, "Miami", "yellow", [0.231, 0.454], ["Atlanta", "Washington", "Bogota", "Mexico City"]),
            new City(io, game_id, queue, diseases, markers, "Santiago", "yellow", [0.21, 0.765], ["Lima"]),
            new City(io, game_id, queue, diseases, markers, "Sao Paulo", "yellow", [0.323, 0.673], ["Buenos Aires", "Bogota", "Lagos", "Madrid"]),

            new City(io, game_id, queue, diseases, markers, "Algiers", "black", [0.479, 0.4], ["Madrid", "Paris", "Istanbul", "Cairo"]), // Black
            new City(io, game_id, queue, diseases, markers, "Baghdad", "black", [0.59, 0.387], ["Istanbul", "Cairo", "Riyadh", "Karachi", "Tehran"]),
            new City(io, game_id, queue, diseases, markers, "Cairo", "black", [0.531, 0.419], ["Algiers", "Istanbul", "Baghdad", "Riyadh", "Khartoum"]),
            new City(io, game_id, queue, diseases, markers, "Chennai", "black", [0.716, 0.544], ["Mumbai", "Delhi", "Kolkata", "Bangkok", "Jakarta"]),
            new City(io, game_id, queue, diseases, markers, "Delhi", "black", [0.707, 0.39], ["Tehran", "Karachi", "Mumbai", "Chennai", "Kolkata"]),
            new City(io, game_id, queue, diseases, markers, "Istanbul", "black", [0.54, 0.337], ["Milan", "Algiers", "St. Petersburg", "Moscow", "Baghdad", "Cairo"]),
            new City(io, game_id, queue, diseases, markers, "Karachi", "black", [0.655, 0.418], ["Riyadh", "Baghdad", "Tehran", "Delhi", "Mumbai"]),
            new City(io, game_id, queue, diseases, markers, "Kolkata", "black", [0.755, 0.414], ["Delhi", "Chennai", "Bangkok", "Hong Kong"]),
            new City(io, game_id, queue, diseases, markers, "Moscow", "black", [0.594, 0.281], ["St. Petersburg", "Istanbul", "Tehran"]),
            new City(io, game_id, queue, diseases, markers, "Mumbai", "black", [0.663, 0.491], ["Karachi", "Delhi", "Chennai"]),
            new City(io, game_id, queue, diseases, markers, "Riyadh", "black", [0.599, 0.474], ["Cairo", "Baghdad", "Karachi"]),
            new City(io, game_id, queue, diseases, markers, "Tehran", "black", [0.643, 0.326], ["Moscow", "Baghdad", "Karachi", "Delhi"]),

            new City(io, game_id, queue, diseases, markers, "Bangkok", "red", [0.764, 0.497], ["Kolkata", "Chennai", "Jakarta", "Ho Chi Minh City", "Hong Kong"]), // Red
            new City(io, game_id, queue, diseases, markers, "Beijing", "red", [0.794, 0.304], ["Seoul", "Shanghai"]),
            new City(io, game_id, queue, diseases, markers, "Ho Chi Minh City", "red", [0.807, 0.568], ["Jakarta", "Bangkok", "Hong Kong", "Manila"]),
            new City(io, game_id, queue, diseases, markers, "Hong Kong", "red", [0.804, 0.453], ["Kolkata", "Shanghai", "Taipei", "Manila", "Ho Chi Minh City", "Bangkok"]),
            new City(io, game_id, queue, diseases, markers, "Jakarta", "red", [0.764, 0.628], ["Chennai", "Bangkok", "Ho Chi Minh City", "Sydney"]),

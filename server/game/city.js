class City {
    constructor(io, game_id, diseases, name, native_disease_colour, location, adjacent_city_names) {
        this.io = io;
...
module.exports = {
    create_cities: function (io, game_id, diseases) {
        city_list = [
            new City(io, game_id, diseases, "Atlanta", "blue", [0.188, 0.373], ["Washington", "Chicago", "Miami"]), // Blue
            ...
            new City(io, game_id, diseases, "San Francisco", "blue", [0.074, 0.336], ["Chicago", "Tokyo", "Manila", "Los Angeles"]),
            ...
            new City(io, game_id, diseases, "Bogota", "yellow", [0.225, 0.552], ["Miami", "Mexico City", "Lima", "Sao Paulo", "Buenos Aires"]), // Yellow
            ...
            new City(io, game_id, diseases, "Los Angeles", "yellow", [0.088, 0.436], ["Sydney", "Mexico City", "San Francisco", "Chicago"]),
            ...
            new City(io, game_id, diseases, "Bangkok", "red", [0.764, 0.497], ["Kolkata", "Chennai", "Jakarta", "Ho Chi Minh City", "Hong Kong"]), // Red
            new City(io, game_id, diseases, "Beijing", "red", [0.794, 0.304], ["Seoul", "Shanghai"]),
